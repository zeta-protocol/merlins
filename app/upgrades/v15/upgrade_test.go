...
import (
	...
	balancer "github.com/merlins-labs/merlins/v15/x/gamm/pool-models/balancer"
	balancertypes "github.com/merlins-labs/merlins/v15/x/gamm/pool-models/balancer"
...
func (suite *UpgradeTestSuite) validateCons(coinsA, coinsB sdk.Coins) {
	...
	for _, coinA := range coinsA {
		...
		furyassert.DecApproxEq(suite.T(), coinBAmount.ToDec(), coinA.Amount.ToDec(), sdk.NewDec(2))
	}
}
