...
import (
	...
	"github.com/merlins-labs/merlins/v15/x/poolmanager/client/cli"
	"github.com/merlins-labs/merlins/v15/x/poolmanager/client/queryproto"
	poolmanagertestutil "github.com/merlins-labs/merlins/v15/x/poolmanager/client/testutil"
...
// 	}{
// 		{
// 			"query pool estimate swap exact amount in", // merlinsd query poolmanager estimate-swap-exact-amount-in 1 cosmos1n8skk06h3kyh550ad9qketlfhc2l5dsdevd3hq 10.0stake --swap-route-pool-ids=1 --swap-route-denoms=node0token
// 			[]string{
// 				"1",
...
func TestGetCmdNumPools(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.NumPoolsRequest]{
		"basic test": {
			Cmd:           "",
...
func TestGetCmdEstimateSwapExactAmountIn(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.EstimateSwapExactAmountInRequest]{
		"basic test": {
...
func TestGetCmdEstimateSwapExactAmountOut(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.EstimateSwapExactAmountOutRequest]{
		"basic test": {
			Cmd: "1 10stake --swap-route-pool-ids=2 --swap-route-denoms=node0token",
...
func TestGetCmdEstimateSinglePoolSwapExactAmountIn(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.EstimateSinglePoolSwapExactAmountInRequest]{
		"basic test": {
...
func TestGetCmdEstimateSinglePoolSwapExactAmountOut(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.EstimateSinglePoolSwapExactAmountOutRequest]{
		"basic test": {
