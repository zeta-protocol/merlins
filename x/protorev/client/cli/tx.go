...
func NewCmdTx() *cobra.Command {
	...
	furycli.AddTxCmd(txCmd, CmdSetDeveloperAccount)
	furycli.AddTxCmd(txCmd, CmdSetMaxPoolPointsPerTx)
	furycli.AddTxCmd(txCmd, CmdSetMaxPoolPointsPerBlock)
	txCmd.AddCommand(
...
func CmdSetDeveloperHotRoutes() *furycli.TxCliDesc {
...
func CmdSetDeveloperAccount() (*furycli.TxCliDesc, *types.MsgSetDeveloperAccount) {
...
func CmdSetMaxPoolPointsPerTx() (*furycli.TxCliDesc, *types.MsgSetMaxPoolPointsPerTx) {
	return &furycli.TxCliDesc{
...
func CmdSetMaxPoolPointsPerBlock() (*furycli.TxCliDesc, *types.MsgSetMaxPoolPointsPerBlock) {
	return &furycli.TxCliDesc{
...
func CmdSetPoolWeights() *furycli.TxCliDesc {
	desc := furycli.TxCliDesc{
...
func CmdSetBaseDenoms() *furycli.TxCliDesc {
	desc := furycli.TxCliDesc{
