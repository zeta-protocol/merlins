...
func init() {
	...
	proto.RegisterType((*QueryGetProtoRevPoolWeightsRequest)(nil), "merlins.protorev.v1beta1.QueryGetProtoRevPoolWeightsRequest")
	proto.RegisterType((*QueryGetProtoRevPoolWeightsResponse)(nil), "merlins.protorev.v1beta1.QueryGetProtoRevPoolWeightsResponse")
...
func (c *queryClient) GetProtoRevPoolWeights(ctx context.Context, in *QueryGetProtoRevPoolWeightsRequest, opts ...grpc.CallOption) (*QueryGetProtoRevPoolWeightsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.protorev.v1beta1.Query/GetProtoRevPoolWeights", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetProtoRevPoolWeights_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.protorev.v1beta1.Query/GetProtoRevPoolWeights",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
