...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&SetProtoRevEnabledProposal{}, "merlins/SetProtoRevEnabledProposal")
	govtypes.RegisterProposalType(ProposalTypeSetProtoRevAdminAccount)
	govtypes.RegisterProposalTypeCodec(&SetProtoRevAdminAccountProposal{}, "merlins/SetProtoRevAdminAccountProposal")
}
