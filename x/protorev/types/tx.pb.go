...
func init() {
	...
	proto.RegisterType((*MsgSetPoolWeights)(nil), "merlins.protorev.v1beta1.MsgSetPoolWeights")
	proto.RegisterType((*MsgSetPoolWeightsResponse)(nil), "merlins.protorev.v1beta1.MsgSetPoolWeightsResponse")
...
func (c *msgClient) SetPoolWeights(ctx context.Context, in *MsgSetPoolWeights, opts ...grpc.CallOption) (*MsgSetPoolWeightsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.protorev.v1beta1.Msg/SetPoolWeights", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetPoolWeights_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.protorev.v1beta1.Msg/SetPoolWeights",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
