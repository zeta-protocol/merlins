...
Find below a lost of `merlinsd` commands added with the `x/protorev` module. A CLI command can look like this:

```bash
merlinsd query protorev params
```
...
| --- | --- | --- |
| gRPC | merlins.v14.protorev.Query/Params | Queries the parameters of the module |
| gRPC | merlins.v14.protorev.Query/GetProtoRevNumberOfTrades | Queries the number of arbitrage trades the module has executed |
| gRPC | merlins.v14.protorev.Query/GetProtoRevProfitsByDenom | Queries the profits of the module by denom |
| gRPC | merlins.v14.protorev.Query/GetProtoRevAllProfits | Queries all of the profits from the module |
| gRPC | merlins.v14.protorev.Query/GetProtoRevStatisticsByRoute | Queries the number of arbitrages and profits that have been executed for a given route |
| gRPC | merlins.v14.protorev.Query/GetProtoRevAllStatistics | Queries all of routes that the module has arbitrage against and the number of trades and profits that have been executed for each route |
| gRPC | merlins.v14.protorev.Query/GetProtoRevTokenPairArbRoutes | Queries all of the hot routes that the module is currently arbitraging |
| gRPC | merlins.v14.protorev.Query/GetProtoRevMaxPoolPointsPerTx | Queries the ProtoRev max pool points per transaction |
| gRPC | merlins.v14.protorev.Query/GetProtoRevMaxPoolPointsPerBlock | Queries the ProtoRev max pool points per block |
| gRPC | merlins.v14.protorev.Query/GetProtoRevAdminAccount | Queries the admin account of the ProtoRev |
| gRPC | merlins.v14.protorev.Query/GetProtoRevDeveloperAccount | Queries the developer account of the ProtoRev |
| gRPC | merlins.v14.protorev.Query/GetProtoRevBaseDenoms | Queries the ProtoRev base denoms used to create cyclic arbitrage routes |
| gRPC | merlins.v14.protorev.Query/GetProtoRevEnabled | Queries whether the ProtoRev module is currently enabled |
| gRPC | merlins.14.protorev.Query/GetProtoRevPoolWeights | Queries the number of pool points each pool type will consume when executing and simulating trades |
| gRPC | merlins.14.protorev.Query/GetProtoRevPool | Queries the pool id for a given denom pair stored in ProtoRev |
| GET | /merlins/v14/protorev/params | Queries the parameters of the module |
| GET | /merlins/v14/protorev/number_of_trades | Queries the number of arbitrage trades the module has executed |
| GET | /merlins/v14/protorev/profits_by_denom | Queries the profits of the module by denom |
| GET | /merlins/v14/protorev/all_profits | Queries all of the profits from the module |
| GET | /merlins/v14/protorev/statistics_by_route | Queries the number of arbitrages and profits that have happened for a given route |
| GET | /merlins/v14/protorev/all_route_statistics | Queries all of routes that the module has arbitrage against and the number of trades and profits that have happened for each route |
| GET | /merlins/v14/protorev/token_pair_arb_routes | Queries all of the hot routes that the module is currently arbitraging |
| GET | /merlins/v14/protorev/max_pool_points_per_tx | Queries the maximum number of pool points that can be consumed per transaction |
| GET | /merlins/v14/protorev/max_pool_points_per_block | Queries the maximum number of pool points that can be consumed per block |
| GET | /merlins/v14/protorev/admin_account | Queries the admin account of the ProtoRev |
| GET | /merlins/v14/protorev/developer_account | Queries the developer account of the ProtoRev |
| GET | /merlins/v14/protorev/base_denoms | Queries the base denominations ProtoRev is currently using to create cyclic arbitrage routes |
| GET | /merlins/v14/protorev/enabled | Queries whether the ProtoRev module is currently enabled |
| GET | /merlins/v14/protorev/pool_weights | Queries the number of pool points each pool type will consume when executing and simulating trades |
| GET | /merlins/v14/protorev/pool | Queries the pool id for a given denom pair stored in ProtoRev |

### Transactions

| Verb | Method | Description |
| --- | --- | --- |
| gRPC | merlins.v14.protorev.Msg/SetHotRoutes | Sets the hot routes that will be explored when creating cyclic arbitrage routes. Can only be called by the admin account |
| gRPC | merlins.v14.protorev.Msg/SetDeveloperAccount | Sets the account that can withdraw a portion of the profit from the ProtoRev module. Can only be called by the admin account |
| gRPC | merlins.v14.protorev.Msg/SetMaxPoolPointsPerTx | Sets the maximum number of pool points that can be consumed per transaction |
| gRPC | merlins.v14.protorev.Msg/SetMaxPoolPointsPerBlock | Sets the maximum number of routes that can be iterated per block |
| gRPC | merlins.v14.protorev.Msg/SetBaseDenoms | Sets the base denominations the ProtoRev module will use to create cyclic arbitrage routes |
| gRPC | merlins.v14.protorev.Msg/SetPoolWeights | Sets the amount of pool points each pool type will consume when executing and simulating trades |
| POST | /merlins/v14/protorev/set_hot_routes | Sets the hot routes that will be explored when creating cyclic arbitrage routes. Can only be called by the admin account |
| POST | /merlins/v14/protorev/set_developer_account | Sets the account that can withdraw a portion of the profit from the ProtoRev module. Can only be called by the admin account |
| POST | /merlins/v14/protorev/set_max_pool_points_per_tx | Sets the maximum number of pool points that can be consumed per transaction |
| POST | /merlins/v14/protorev/set_max_pool_points_per_block | Sets the maximum number of pool points that can be consumed per block |
| POST | /merlins/v14/protorev/set_pool_weights | Sets the amount of pool points each pool type will consume when executing and simulating trades |
| POST | /merlins/v14/protorev/set_base_denoms | Sets the base denominations that will be used by ProtoRev to construct cyclic arbitrage routes |
