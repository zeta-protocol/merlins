...
func (suite *KeeperTestSuite) TestGetProtoRevNumberOfTrades() {
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinsDenomination, sdk.NewInt(10000))
	suite.Require().NoError(err)
...
func (suite *KeeperTestSuite) TestGetProtoRevAllProfits() {
	...
	// Pseudo execute a trade
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{}, types.MerlinsDenomination, sdk.NewInt(9000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Profits, fury)
...
func (suite *KeeperTestSuite) TestGetProtoRevStatisticsByRoute() {
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinsDenomination, sdk.NewInt(80000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Statistics.Profits, furyCoin)
}
...
func (suite *KeeperTestSuite) TestGetProtoRevAllRouteStatistics() {
	...
	// Pseudo execute a trade
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 3}}, types.MerlinsDenomination, sdk.NewInt(10000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Statistics[0].Profits, furyCoin)
	...
	err = suite.App.AppKeepers.ProtoRevKeeper.UpdateStatistics(suite.Ctx, poolmanagertypes.SwapAmountInRoutes{{TokenOutDenom: "", PoolId: 1}, {TokenOutDenom: "", PoolId: 2}, {TokenOutDenom: "", PoolId: 4}}, types.MerlinsDenomination, sdk.NewInt(70000))
	suite.Require().NoError(err)
	...
	suite.Require().Contains(res.Statistics[1].Profits, furyCoin)
