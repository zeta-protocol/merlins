...
import (
	...
	"github.com/merlins-labs/merlins/v15/x/protorev/keeper"
	...
	tests := []struct {
		...
		},
		{
			...
			params: param{
				...
				txFee:               sdk.NewCoins(sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000))),
				minGasPrices:        sdk.NewDecCoins(),
				gasLimit:            500000,
				isCheckTx:           false,
				baseDenomGas:        true,
			...
			params: param{
				msgs: []sdk.Msg{
					&poolmanagertypes.MsgSwapExactAmountIn{
						...
						TokenIn:           sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000)),
						TokenOutMinAmount: sdk.NewInt(100),
					},
				},
				txFee:               sdk.NewCoins(sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000))),
			...
			params: param{
				msgs: []sdk.Msg{
					...
					&poolmanagertypes.MsgSwapExactAmountIn{
						...
						TokenIn:           sdk.NewCoin("ufury", sdk.NewInt(10000)),
						TokenOutMinAmount: sdk.NewInt(10000),
					},
				},
				txFee:              sdk.NewCoins(sdk.NewCoin("ufury", sdk.NewInt(10000))),
...
func setUpBenchmarkSuite(msgs []sdk.Msg) (*KeeperTestSuite, authsigning.Tx, sdk.AnteHandler) {
	...
	acc1 := suite.App.AccountKeeper.NewAccountWithAddress(suite.Ctx, addr0)
	suite.App.AccountKeeper.SetAccount(suite.Ctx, acc1)
	simapp.FundAccount(suite.App.BankKeeper, suite.Ctx, addr0, sdk.NewCoins(sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000))))
	...
	tx := suite.BuildTx(txBuilder, msgs, sigV2, "", sdk.NewCoins(sdk.NewCoin(types.MerlinsDenomination, sdk.NewInt(10000))), 500000)
