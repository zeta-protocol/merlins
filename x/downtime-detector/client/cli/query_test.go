...
import (
	...
	"github.com/merlins-labs/merlins/v15/x/downtime-detector/client/cli"
...
func TestRecoveredSinceQueryCmd(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*queryproto.RecoveredSinceDowntimeOfLengthRequest]{
		"basic test": {
			Cmd: "30s 10m",
