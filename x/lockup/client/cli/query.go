...
func GetQueryCmd() *cobra.Command {
	...
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdModuleBalance)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdModuleLockedAmount)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdAccountUnlockingCoins)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdAccountLockedPastTime)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdAccountLockedPastTimeNotUnlockingOnly)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdTotalLockedByDenom)
	cmd.AddCommand(
...
func GetCmdModuleBalance() (*furycli.QueryDescriptor, *types.ModuleBalanceRequest) {
...
func GetCmdModuleLockedAmount() (*furycli.QueryDescriptor, *types.ModuleLockedAmountRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdAccountUnlockingCoins() (*furycli.QueryDescriptor, *types.AccountUnlockingCoinsRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdAccountLockedCoins() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountLockedCoinsRequest](
...
func GetCmdAccountLockedPastTime() (*furycli.QueryDescriptor, *types.AccountLockedPastTimeRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdAccountLockedPastTimeNotUnlockingOnly() (*furycli.QueryDescriptor, *types.AccountLockedPastTimeNotUnlockingOnlyRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdAccountUnlockedBeforeTime() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountUnlockedBeforeTimeRequest](
...
func GetCmdAccountLockedPastTimeDenom() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountLockedPastTimeDenomRequest](
...
{{.CommandPrefix}} lock-by-id 1`,
	...
	q.Long = furycli.FormatLongDesc(q.Long, furycli.NewLongMetadata(types.ModuleName).WithShort(q.Short))
	return furycli.BuildQueryCli[*types.LockedRequest](&q, types.NewQueryClient)
}

// GetCmdNextLockID returns next lock id to be created.
func GetCmdNextLockID() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.NextLockIDRequest](
		"next-lock-id",
...
func GetCmdSyntheticLockupsByLockupID() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.SyntheticLockupsByLockupIDRequest](
...
func GetCmdAccountLockedLongerDuration() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountLockedLongerDurationRequest](
...
func GetCmdAccountLockedDuration() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountLockedDurationRequest](
...
func GetCmdAccountLockedLongerDurationNotUnlockingOnly() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AccountLockedLongerDurationNotUnlockingOnlyRequest](
