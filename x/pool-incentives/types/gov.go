...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdatePoolIncentivesProposal{}, "merlins/UpdatePoolIncentivesProposal")
	govtypes.RegisterProposalType(ProposalTypeReplacePoolIncentives)
	govtypes.RegisterProposalTypeCodec(&ReplacePoolIncentivesProposal{}, "merlins/ReplacePoolIncentivesProposal")
}
