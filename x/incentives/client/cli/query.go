...
func GetQueryCmd() *cobra.Command {
	...
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdGauges)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdToDistributeCoins)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdGaugeByID)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdActiveGauges)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdActiveGaugesPerDenom)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdUpcomingGauges)
	furycli.AddQueryCmd(cmd, qcGetter, GetCmdUpcomingGaugesPerDenom)
...
func GetCmdGauges() (*furycli.QueryDescriptor, *types.GaugesRequest) {
...
func GetCmdToDistributeCoins() (*furycli.QueryDescriptor, *types.ModuleToDistributeCoinsRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdGaugeByID() (*furycli.QueryDescriptor, *types.GaugeByIDRequest) {
	return &furycli.QueryDescriptor{
		Use:   "gauge-by-id [id]",
...
func GetCmdActiveGauges() (*furycli.QueryDescriptor, *types.ActiveGaugesRequest) {
	return &furycli.QueryDescriptor{
		Use:   "active-gauges",
...
func GetCmdActiveGaugesPerDenom() (*furycli.QueryDescriptor, *types.ActiveGaugesPerDenomRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdUpcomingGauges() (*furycli.QueryDescriptor, *types.UpcomingGaugesRequest) {
	return &furycli.QueryDescriptor{
		Use:   "upcoming-gauges",
...
func GetCmdUpcomingGaugesPerDenom() (*furycli.QueryDescriptor, *types.UpcomingGaugesPerDenomRequest) {
	return &furycli.QueryDescriptor{
