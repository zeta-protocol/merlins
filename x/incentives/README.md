...
```sh
merlinsd tx incentives create-gauge [lockup_denom] [reward] [flags]
```
...
```bash
merlinsd tx incentives create-gauge gamm/pool/3 10000ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 \
...
```bash
merlinsd tx incentives create-gauge ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 \
...
```sh
merlinsd tx incentives add-to-gauge [gauge_id] [rewards] [flags]
```
...
```bash
merlinsd tx incentives add-to-gauge 1914 500000000ibc/46B44899322F3CD854D2D46DEEF881958467CDD4B3B10086DA49296BBED94BED \
--from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd query incentives active-gauges [flags]
```

::: details Example

```bash
merlinsd query incentives active-gauges
```
...
```sh
merlinsd query incentives active-gauges-per-denom [denom] [flags]
```
...
```bash
merlinsd query incentives active-gauges-per-denom gamm/pool/341
```
...
```sh
merlinsd query incentives distributed-coins [flags]
```

::: details Example

```bash
merlinsd query incentives distributed-coins
```
...
```sh
merlinsd query incentives gauge-by-id [id] [flags]
```
...
```sh
merlinsd query incentives gauge-by-id 1
```
...
```sh
merlinsd query incentives gauges [flags]
```
...
```bash
merlinsd query incentives gauges --limit 2000
```
...
```sh
merlinsd query incentives to-distribute-coins [flags]
```

::: details Example

```bash
merlinsd query incentives to-distribute-coins
```
...
```sh
merlinsd query incentives upcoming-gauges [flags]
```

::: details Example

```bash
merlinsd query incentives upcoming-gauges
```
