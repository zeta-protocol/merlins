...
// source: merlins/epochs/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "merlins.epochs.v1beta1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "merlins.epochs.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("merlins/epochs/genesis.proto", fileDescriptor_7ecf3e4d59074cbd) }
