...
func GetCmdAllSuperfluidAssets() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AllAssetsRequest](
...
func GetCmdAssetMultiplier() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AssetMultiplierRequest](
...
func GetCmdAllIntermediaryAccounts() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.AllIntermediaryAccountsRequest](
...
func GetCmdConnectedIntermediaryAccount() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.ConnectedIntermediaryAccountRequest](
...
func GetCmdSuperfluidDelegationAmount() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.SuperfluidDelegationAmountRequest](
...
func GetCmdSuperfluidUndelegationsByDelegator() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.SuperfluidUndelegationsByDelegatorRequest](
...
func GetCmdTotalSuperfluidDelegations() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.TotalSuperfluidDelegationsRequest](
...
func GetCmdTotalDelegationByDelegator() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryTotalDelegationByDelegatorRequest](
...
func GetCmdUnpoolWhitelist() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryUnpoolWhitelistRequest](
		"unpool-whitelist",
