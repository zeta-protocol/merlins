...
func NewSuperfluidUndelegateCmd() *cobra.Command {
	return furycli.BuildTxCli[*types.MsgSuperfluidUndelegate](&furycli.TxCliDesc{
...
func NewSuperfluidUnbondLockCmd() *cobra.Command {
	return furycli.BuildTxCli[*types.MsgSuperfluidUnbondLock](&furycli.TxCliDesc{
...
func NewSuperfluidUndelegateAndUnbondLockCmd() *cobra.Command {
	return furycli.BuildTxCli[*types.MsgSuperfluidUndelegateAndUnbondLock](&furycli.TxCliDesc{
...
func NewCmdUnPoolWhitelistedPool() *cobra.Command {
	return furycli.BuildTxCli[*types.MsgUnPoolWhitelistedPool](&furycli.TxCliDesc{
...
func NewCmdUpdateUnpoolWhitelistProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "merlinsd tx gov submit-proposal update-unpool-whitelist --pool-ids \"1, 2, 3\" --title \"Title\" --description \"Description\"",
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
				return err
