...
// source: merlins/concentrated-liquidity/pool-model/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateConcentratedPool)(nil), "merlins.concentratedliquidity.v1beta1.MsgCreateConcentratedPool")
	proto.RegisterType((*MsgCreateConcentratedPoolResponse)(nil), "merlins.concentratedliquidity.v1beta1.MsgCreateConcentratedPoolResponse")
}

func init() {
	proto.RegisterFile("merlins/concentrated-liquidity/pool-model/tx.proto", fileDescriptor_6c324e8c9dd2851d)
}
...
func (c *msgCreatorClient) CreateConcentratedPool(ctx context.Context, in *MsgCreateConcentratedPool, opts ...grpc.CallOption) (*MsgCreateConcentratedPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.concentratedliquidity.v1beta1.MsgCreator/CreateConcentratedPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgCreator_CreateConcentratedPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.concentratedliquidity.v1beta1.MsgCreator/CreateConcentratedPool",
	}
...
var _MsgCreator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlins.concentratedliquidity.v1beta1.MsgCreator",
	...
	Metadata: "merlins/concentrated-liquidity/pool-model/tx.proto",
}
