...
import (
	...
	furysimtypes "github.com/merlins-labs/merlins/v15/simulation/simtypes"
	clkeeper "github.com/merlins-labs/merlins/v15/x/concentrated-liquidity"
	clmodeltypes "github.com/merlins-labs/merlins/v15/x/concentrated-liquidity/model"
...
func RandMsgCollectFees(k clkeeper.Keeper, sim *furysimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgCollectFees, error) {
	// get random pool
	clPool, poolDenoms, err := getRandCLPool(k, sim, ctx)
	if err != nil {
		return nil, err
...
func RandMsgCreateIncentives(k clkeeper.Keeper, sim *furysimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgCreateIncentive, error) {
	rand := sim.GetRand()
	// get random pool
	clPool, poolDenoms, err := getRandCLPool(k, sim, ctx)
	if err != nil {
