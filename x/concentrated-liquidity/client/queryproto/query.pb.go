...
func init() {
	...
	proto.RegisterType((*ClaimableFeesRequest)(nil), "merlins.concentratedliquidity.v1beta1.ClaimableFeesRequest")
	proto.RegisterType((*ClaimableFeesResponse)(nil), "merlins.concentratedliquidity.v1beta1.ClaimableFeesResponse")
...
func (c *queryClient) ClaimableFees(ctx context.Context, in *ClaimableFeesRequest, opts ...grpc.CallOption) (*ClaimableFeesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlins.concentratedliquidity.v1beta1.Query/ClaimableFees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ClaimableFees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlins.concentratedliquidity.v1beta1.Query/ClaimableFees",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
