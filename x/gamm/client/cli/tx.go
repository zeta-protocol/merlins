...
import (
	...
	"github.com/merlins-labs/merlins/v15/x/gamm/pool-models/stableswap"
...
func NewTxCmd() *cobra.Command {
	...
	furycli.AddTxCmd(txCmd, NewJoinPoolCmd)
	furycli.AddTxCmd(txCmd, NewExitPoolCmd)
	furycli.AddTxCmd(txCmd, NewSwapExactAmountInCmd)
	furycli.AddTxCmd(txCmd, NewSwapExactAmountOutCmd)
	furycli.AddTxCmd(txCmd, NewJoinSwapExternAmountIn)
	furycli.AddTxCmd(txCmd, NewJoinSwapShareAmountOut)
	furycli.AddTxCmd(txCmd, NewExitSwapExternAmountOut)
	furycli.AddTxCmd(txCmd, NewExitSwapShareAmountIn)
	txCmd.AddCommand(
...
func NewCreatePoolCmd() *furycli.TxCliDesc {
	desc := furycli.TxCliDesc{
...
func NewJoinPoolCmd() (*furycli.TxCliDesc, *types.MsgJoinPool) {
	return &furycli.TxCliDesc{
		...
		CustomFieldParsers: map[string]furycli.CustomFieldParserFn{
			"TokenInMaxs": furycli.FlagOnlyParser(maxAmountsInParser),
		},
		Flags: furycli.FlagDesc{RequiredFlags: []*flag.FlagSet{FlagSetJoinPool()}},
	}, &types.MsgJoinPool{}
}

func NewExitPoolCmd() (*furycli.TxCliDesc, *types.MsgExitPool) {
	return &furycli.TxCliDesc{
		Use:   "exit-pool",
		...
		CustomFieldParsers: map[string]furycli.CustomFieldParserFn{
			"TokenOutMins": furycli.FlagOnlyParser(minAmountsOutParser),
		},
		Flags: furycli.FlagDesc{RequiredFlags: []*flag.FlagSet{FlagSetExitPool()}},
	}, &types.MsgExitPool{}
}

func NewSwapExactAmountInCmd() (*furycli.TxCliDesc, *types.MsgSwapExactAmountIn) {
	return &furycli.TxCliDesc{
		Use:   "swap-exact-amount-in [token-in] [token-out-min-amount]",
		Short: "swap exact amount in",
		CustomFieldParsers: map[string]furycli.CustomFieldParserFn{
			"Routes": furycli.FlagOnlyParser(swapAmountInRoutes),
		},
		Flags: furycli.FlagDesc{RequiredFlags: []*flag.FlagSet{FlagSetMultihopSwapRoutes()}},
	}, &types.MsgSwapExactAmountIn{}
}

func NewSwapExactAmountOutCmd() (*furycli.TxCliDesc, *types.MsgSwapExactAmountOut) {
...
func NewJoinSwapExternAmountIn() (*furycli.TxCliDesc, *types.MsgJoinSwapExternAmountIn) {
	return &furycli.TxCliDesc{
...
func NewJoinSwapShareAmountOut() (*furycli.TxCliDesc, *types.MsgJoinSwapShareAmountOut) {
	return &furycli.TxCliDesc{
...
func NewExitSwapExternAmountOut() (*furycli.TxCliDesc, *types.MsgExitSwapExternAmountOut) {
	return &furycli.TxCliDesc{
...
func NewExitSwapShareAmountIn() (*furycli.TxCliDesc, *types.MsgExitSwapShareAmountIn) {
	return &furycli.TxCliDesc{
