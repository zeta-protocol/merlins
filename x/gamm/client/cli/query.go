...
func GetQueryCmd() *cobra.Command {
	...
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdPool)
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdSpotPrice)
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdPool)
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdPools)
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdEstimateSwapExactAmountIn)
	furycli.AddQueryCmd(cmd, types.NewQueryClient, GetCmdEstimateSwapExactAmountOut)
	cmd.AddCommand(
		GetCmdNumPools(),
		GetCmdPoolParams(),
		GetCmdTotalShares(),
...
// nolint: staticcheck
func GetCmdPool() (*furycli.QueryDescriptor, *types.QueryPoolRequest) {
...
func GetCmdPools() (*furycli.QueryDescriptor, *types.QueryPoolsRequest) {
	return &furycli.QueryDescriptor{
		Use:   "pools",
		Short: "Query pools",
		Long: `{{.Short}}{{.ExampleHeader}}
...
func GetCmdNumPools() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryNumPoolsRequest](
		"num-pools",
...
func GetCmdTotalShares() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryTotalSharesRequest](
		"total-share [poolID]",
		"Query total-share",
		`Query total-share.
Example:
...
func GetCmdQueryTotalLiquidity() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryTotalLiquidityRequest](
		"total-liquidity",
...
func GetCmdSpotPrice() (*furycli.QueryDescriptor, *types.QuerySpotPriceRequest) {
	return &furycli.QueryDescriptor{
...
// Deprecated: use alternate in x/poolmanager.
func GetCmdEstimateSwapExactAmountIn() (*furycli.QueryDescriptor, *types.QuerySwapExactAmountInRequest) {
	return &furycli.QueryDescriptor{
...
// Deprecated: use alternate in x/poolmanager.
func GetCmdEstimateSwapExactAmountOut() (*furycli.QueryDescriptor, *types.QuerySwapExactAmountOutRequest) {
	return &furycli.QueryDescriptor{
...
func GetCmdPoolType() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryPoolTypeRequest](
		"pool-type <pool_id>",
		"Query pool type",
		`Query pool type
Example:
...
func GetCmdTotalPoolLiquidity() *cobra.Command {
	return furycli.SimpleQueryCmd[*types.QueryTotalPoolLiquidityRequest](
