...
import (
	...
	"github.com/merlins-labs/merlins/v15/x/gamm/client/cli"
...
func TestNewCreatePoolCmd(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(tt *testing.T) {
			...
			txTc := furycli.TxCliTestCase[*balancer.MsgCreateBalancerPool]{
				Cmd:                    Cmd,
				ExpectedErr:            tc.expectErr,
				OnlyCheckValidateBasic: true,
			}
			furycli.RunTxTestCase(tt, desc, &txTc)
		})
	}
}
...
func TestNewJoinPoolCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgJoinPool]{
		"join pool": {
...
func TestNewExitPoolCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgExitPool]{
		"exit pool": {
...
func TestNewSwapExactAmountOutCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgSwapExactAmountOut]{
...
func TestNewSwapExactAmountInCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgSwapExactAmountIn]{
...
func TestNewJoinSwapExternAmountInCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgJoinSwapExternAmountIn]{
		"swap exact amount in": {
...
func TestNewJoinSwapShareAmountOutCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgJoinSwapShareAmountOut]{
		"swap exact amount in": {
...
func TestNewExitSwapExternAmountOutCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgExitSwapExternAmountOut]{
		"swap exact amount in": {
			Cmd: "10stake 1 --pool-id=1 --from=" + testAddresses[0].String(),
...
func TestNewExitSwapShareAmountInCmd(t *testing.T) {
	...
	tcs := map[string]furycli.TxCliTestCase[*types.MsgExitSwapShareAmountIn]{
		"swap exact amount in": {
			Cmd: "stake 10 1 --pool-id=1 --from=" + testAddresses[0].String(),
...
func TestGetCmdPools(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*types.QueryPoolsRequest]{
		"basic test": {
			Cmd: "--offset=2",
...
func TestGetCmdPool(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*types.QueryPoolRequest]{
		"basic test": {
			Cmd:           "1",
...
func TestGetCmdSpotPrice(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*types.QuerySpotPriceRequest]{
		"basic test": {
			Cmd: "1 ufury ibc/111",
...
func TestGetCmdEstimateSwapExactAmountIn(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*types.QuerySwapExactAmountInRequest]{
		"basic test": {
...
func TestGetCmdEstimateSwapExactAmountOut(t *testing.T) {
	...
	tcs := map[string]furycli.QueryCliTestCase[*types.QuerySwapExactAmountOutRequest]{
		"basic test": {
			Cmd: "1 osm11vmx8jtggpd9u7qr0t8vxclycz85u925sazglr7 10stake --swap-route-pool-ids=2 --swap-route-denoms=node0token",
