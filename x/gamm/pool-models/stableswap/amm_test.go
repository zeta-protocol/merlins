...
import (
	...
	sdkrand "github.com/merlins-labs/merlins/v15/simulation/simtypes/random"
	"github.com/merlins-labs/merlins/v15/x/gamm/pool-models/internal/cfmm_common"
	"github.com/merlins-labs/merlins/v15/x/gamm/pool-models/internal/test_helpers"
...
func TestCFMMInvariantTwoAssets(t *testing.T) {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			furyassert.ConditionalPanic(t, test.expectPanic, sut)
		})
	}
}
...
func TestJoinPoolSharesInternal(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			...
			furyassert.ConditionalError(t, !tc.expectPass, err)
		})
	}
}
