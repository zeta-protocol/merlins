...
```sh
merlinsd tx gamm create-pool [config-file] --from --chain-id
```
...
```sh
merlinsd tx gamm create-pool --pool-file [config-file] --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm join-pool --pool-id --max-amounts-in --share-amount-out --from --chain-id
```
...
```sh
merlinsd tx gamm join-pool --pool-id 3 --max-amounts-in 37753ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 --share-amount-out 1227549469722224220 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm exit-pool --pool-id --min-amounts-out --share-amount-in --from --chain-id
```
...
```sh
merlinsd tx gamm exit-pool --pool-id 3 --min-amounts-out 33358ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 --share-amount-in 1136326462628731195 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm join-swap-extern-amount-in [token-in] [share-out-min-amount] --from --pool-id --chain-id
```
...
```sh
merlinsd tx gamm join-swap-extern-amount-in 200000ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 3234812471272883046 --pool-id 3 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm exit-swap-extern-amount-out [token-out] [share-in-max-amount] --pool-id --from --chain-id
```
...
```sh
merlinsd tx gamm exit-swap-extern-amount-out 199430ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 3408979387886193586 --pool-id 3 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm join-swap-share-amount-out [token-in-denom] [share-out-amount] [token-in-max-amount] --pool-id --from --chain-id
```
...
```sh
merlinsd tx gamm join-swap-share-amount-out ufury 14481270389710236872 312466 --pool-id 3 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm exit-swap-share-amount-in [token-out-denom] [share-in-amount] [token-out-min-amount] --pool-id --from --chain-id
```
...
```sh
merlinsd tx gamm exit-swap-share-amount-in ufury 14563185400026723131 298548 --pool-id 3 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm swap-exact-amount-in [token-in] [token-out-min-amount] --pool-id --from --chain-id
```
...
```sh
merlinsd tx gamm swap-exact-amount-in 407239ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 140530 --swap-route-pool-ids 3 --swap-route-denoms ufury --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd tx gamm swap-exact-amount-out [token-out] [token-out-max-amount] --swap-route-pool-ids --from --chain-id
```
...
```sh
merlinsd tx gamm swap-exact-amount-out 140530ufury 407239 --swap-route-pool-ids 3 --swap-route-denoms ibc/1480B8FD20AD5FCAE81EA87584D269547DD4D436843C1D20F15E00EB64743EF4 --from WALLET_NAME --chain-id merlins-1
```
...
```sh
merlinsd query gamm estimate-swap-exact-amount-in <poolID> <sender> <tokenIn> [flags]
```
...
```sh
merlinsd query gamm estimate-swap-exact-amount-in 1 fury123nfq6m8f88m4g3sky570unsnk4zng4uqv7cm8 1000000ufury --swap-route-pool-ids 1 --swap-route-denoms ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 
```
...
```sh
merlinsd query gamm estimate-swap-exact-amount-out <poolID> <sender> <tokenOut> [flags]
```
...
```sh
merlinsd query gamm estimate-swap-exact-amount-out 1 fury123nfq6m8f88m4g3sky570unsnk4zng4uqv7cm8 1000000ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 --swap-route-pool-ids 1 --swap-route-denoms ufury
```
...
```sh
merlinsd query gamm pool <poolID> [flags]
```
...
```sh
merlinsd query gamm pool-assets <poolID> [flags]
```
...
```sh
merlinsd query gamm pool-assets 1
```
...
```sh
merlinsd query gamm pool-params <poolID> [flags]
```
...
```sh
merlinsd query gamm pool-params 1
```
...
```sh
merlinsd query gamm spot-price 1 ufury ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2
```
...
```sh
merlinsd query gamm total-liquidity
```
...
```sh
merlinsd query gamm total-share <poolID> [flags]
```
...
```sh
merlinsd query gamm total-share 1
```
