...
const (
	...
	addressPrefix                   = "fury"
	localmerlinsFromHomePath        = "/.merlinsd-local"
...
func main() {
	...
	log.Printf("\n\n\nWARNING 1: your localmerlins and client home are assummed to be %s. Run 'merlinsd get-env' and confirm it matches the path you see printed here\n\n\n", clientHome)
