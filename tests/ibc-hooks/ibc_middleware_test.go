...
import (
	...
	"github.com/merlins-labs/merlins/v15/tests/merlinsibctesting"

	"github.com/merlins-labs/merlins/v15/tests/ibc-hooks/testutils"
)
...
func (suite *HooksTestSuite) SetupCrosschainSwaps(chainName Chain) (sdk.AccAddress, sdk.AccAddress) {
	...
	amounts := sdk.NewCoins(sdk.NewCoin("ufury", i), sdk.NewCoin("stake", i), sdk.NewCoin("token0", i), sdk.NewCoin("token1", i))
