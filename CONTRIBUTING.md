...
- The GitHub release is created via this [GitHub workflow](https://github.com/merlins-labs/merlins/blob/main/.github/workflows/release.yml). The workflow is manually triggered from the [merlins-ci repository](https://github.com/merlins-labs/merlins-ci). The workflow uses the `make build-reproducible` command to create the `merlinsd` binaries using the default [Makefile](https://github.com/merlins-labs/merlins/blob/main/Makefile#L99).
