...
def estimate_test_case_out_given_in(tick_ranges: list[SqrtPriceRange], token_in_initial: Decimal, swap_fee: Decimal, is_zero_for_one: bool) -> Tuple[Decimal, Decimal]:
...
def estimate_single_position_within_one_tick_ofz():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_1 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
    ...
    expected_fee_growth_per_share_total = sdk_dec.new("0.000276701288297452")
...
def estimate_two_positions_within_one_tick_zfo():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_2 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
    ...
    expected_fee_growth_per_share_total = sdk_dec.new("0.000000132091924532")
...
def estimate_two_consecutive_positions_zfo(swap_fee: str, expected_token_out_total: str, expected_fee_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_3 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_ofz_test(swap_fee: str, expected_token_out_total: str, expected_fee_growth_per_share_total: str):
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_4 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_zfo_test(token_in_initial: str, swap_fee: str, expected_token_out_total: str, expected_fee_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo) and not consuming full liquidity of the second position.
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_5 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_consecutive_positions_gap_ofz_test():
    ...
    when swapping token one for zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_6 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
    ...
    expected_fee_growth_per_share_total = sdk_dec.new("0.221769187794051751")
...
def estimate_slippage_protection_zfo_test():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_7 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
    ...
    expected_fee_growth_per_share_total = sdk_dec.new("0.000000085792039652")
