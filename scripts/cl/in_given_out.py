...
def estimate_test_case_in_given_out(tick_ranges: list[SqrtPriceRange], token_out: Decimal, swap_fee: Decimal, is_zero_for_one: bool) -> Tuple[Decimal, Decimal]:
    ...
    token_out_consumed_total, token_in_total, fee_growth_per_share_total = sdk_dec.zero, sdk_dec.zero, sdk_dec.zero
...
def estimate_single_position_within_one_tick_ofz_in_given_out():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_1 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_two_positions_within_one_tick_zfo_in_given_out():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_2 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_two_consecutive_positions_zfo_in_given_out(swap_fee: str, expected_token_in: str, expected_fee_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_3 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_ofz_test_in_given_out():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_4 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_zfo_test_in_given_out(tokein_in_initial: str, swap_fee: str, expected_token_in: str, expected_fee_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo) and not consuming full liquidity of the second position.
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_5 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_consecutive_positions_gap_ofz_test_in_given_out():
    ...
    when swapping token one for zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_6 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
...
def estimate_slippage_protection_zfo_test_in_given_out():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_7 github.com/merlins-labs/merlins/v15/x/concentrated-liquidity
    """
