...
Validator1: `$HOME/.merlinsd/validator1`

Validator2: `$HOME/.merlinsd/validator2`

Validator3: `$HOME/.merlinsd/validator3`
...
Validator2: `merlinsd status --node "tcp://localhost:26654"`

Validator3: `merlinsd status --node "tcp://localhost:26651"`

or

Validator1:
`merlinsd keys list --keyring-backend test --home $HOME/.merlinsd/validator1`

Validator2:
`merlinsd keys list --keyring-backend test --home $HOME/.merlinsd/validator2`
