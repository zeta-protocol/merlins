...
pub struct InstantiateMsg {
    ...
    /// This should be an instance of the Merlins swaprouter contract
...
pub enum FailedDeliveryAction {
    DoNothing,
    /// An merlins addres used to recover any tokens that get stuck in the
...
pub enum ExecuteMsg {
    ...
    MerlinsSwap {
        /// The final denom to be received (as represented on merlins)
        output_denom: String,
        ...
        /// "recovery address" that can clain the funds on merlins after a
        /// confirmed failure.
