...
use merlins_testing::{Account, Bank, Module, Wasm};
...
fn crosschain_swap() {
    ...
    let msg = CrossChainExecute::MerlinsSwap {
        output_denom,
    ...
    // This test cannot be completed until we have ibc tests on merlins testing.
