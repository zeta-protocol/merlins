...
pub mod test {
    ...
    pub fn initialize_contract(mut deps: DepsMut) -> Addr {
        ...
        // Set the CHAIN_ADMIN address as the merlins and mars chain admin
        ...
        // Set the CHAIN_MAINTAINER address as the merlins and mars chain maintainer with the chain admin
        let msg = msg::ExecuteMsg::ModifyAuthorizedAddresses {
            operations: vec![
                AuthorizedAddressInput {
                    operation: execute::Operation::Set,
