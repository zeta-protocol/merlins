...
use merlins_testing::cosmrs::proto::cosmos::bank::v1beta1::QueryAllBalancesRequest;
use merlins_testing::cosmrs::proto::cosmwasm::wasm::v1::MsgExecuteContractResponse;
use merlins_testing::{
    Account, Bank, Module, MerlinsTestApp, RunnerError, RunnerExecuteResult, SigningAccount, Wasm,
};
...
test_swap!(
    ...
    "alloc::vec::Vec<merlins_std::types::merlins::gamm::v1beta1::SwapAmountInRoute> not found: execute wasm contract failed",
...
fn get_amount(
    balances: &Vec<merlins_testing::cosmrs::proto::cosmos::base::v1beta1::Coin>,
    denom: &str,
) -> u128 {
    balances
        .iter()
