...
// source: merlins/sumtree/v1beta1/tree.proto
...
func init() {
	proto.RegisterType((*Node)(nil), "merlins.store.v1beta1.Node")
	proto.RegisterType((*Child)(nil), "merlins.store.v1beta1.Child")
	proto.RegisterType((*Leaf)(nil), "merlins.store.v1beta1.Leaf")
}

func init() {
	proto.RegisterFile("merlins/sumtree/v1beta1/tree.proto", fileDescriptor_31a1c5f55b935f78)
}
