...
func preparePool(t *testing.T, ctx sdk.Context, merlins *app.MerlinsApp, addr sdk.AccAddress, funds []sdk.Coin) uint64 {
	...
	poolId, err := merlins.PoolManagerKeeper.CreatePool(ctx, &msg)
	require.NoError(t, err)
	return poolId
}
