...
// Example:
// 	merlinsd import-genesis-accounts-from-snapshot networks/cosmoshub-3/snapshot.json networks/merlins-1/ions.json output_address.json
// `,
...
// Example:
// 	merlinsd import-genesis-accounts-from-snapshot ../snapshot.json ../ions.json
// 	- Check input genesis:
